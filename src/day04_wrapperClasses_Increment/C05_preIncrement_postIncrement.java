...
public class C05_preIncrement_postIncrement {
    public static void main(String[] args) {
        ...
        /*
        Java'da 3 farklı sekilde deger artirma mumkun
        ...
        // önce deger artirma sonra yazdirma
        System.out.println("++b'den 1 satir sonra konsolda c degeri : " + +b); // 11
