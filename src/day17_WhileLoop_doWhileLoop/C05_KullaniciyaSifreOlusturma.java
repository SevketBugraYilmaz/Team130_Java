...
public class C05_KullaniciyaSifreOlusturma {
    ...
    public static void main(String[] args) {
        ...
        // Gecerli bir sifre yazilincaya kadar
        // bu islemi tekrar edin gecerli sifre yazilinca “sifreniz basari ile kaydedildi” yazdirin
        //  sartlar :ilk harf kucuk harf olmali
        ...
        while (flag > 0) {
            ...
            if ( !(ilkHarf >= 'a' && ilkHarf <= 'z')){
                System.out.println("İlk harf kücük harf olmali");
                flag++;
            }
