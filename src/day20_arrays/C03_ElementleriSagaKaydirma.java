...
public class C03_ElementleriSagaKaydirma {
    ...
    public static void main(String[] args) {
       ...
       // Soru 3- Verilen bir array’deki tum elementleri bir saga kaydirip, sondaki elementi
        // de basa tasiyacak bir method olusturun, array’i yeni haliyle kaydedin.
      //  Orn : input : [4,5,6,7]  array’in son hali. : [7,4,5,6]
        ...
        // bos kovaya aldigimiz elementi , en bosa koyalim
