...
public class C01_CheckedExceptions {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        /*
         ...
         Java'da dosyadan bilgi alma veya dosyaya bilgi yazdirma ( Input/Output)
        ...
        method deklarasyonuna  riskin farkinda oldugumuz beyan eden
        throws keyword yazmamiz yeterlidir

        throws FileNotFoundException :
        method deklarasyonuna ekledigimiz  bu bolum riskin farkinda oldugumuzu soyler
