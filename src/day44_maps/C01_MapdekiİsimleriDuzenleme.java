...
public class C01_MapdekiİsimleriDuzenleme {
    ...
    public static void main(String[] args) {
        ...
        for (Integer eachKey : keySeti
            ...
            eachvalueArr[0] = eachvalueArr[0].substring(0,1).toUpperCase()+ // ilk harf buyuk
                              eachvalueArr[0].substring(1).toUpperCase(); // geriye kalanlar kucuk
            ...
            String yeniValue = eachvalueArr[0] + "-"+eachvalueArr[1]+"-"+eachvalueArr[2]+"-"
                    +eachvalueArr[3]+"-"+ eachvalueArr[4]; // Azim-Mismis-11-K-TM
